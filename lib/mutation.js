...
function createCreateMutation(model, graphqlType) {
  ...
  return {
    ...
    inputFields: (0, _lodash.merge)((0, _graphql2.parsePrimaryKeyinputFields)(model, { exclude: ["id"] }), attributeFields(model, {
...
function createUpdateMutation(model, graphqlType) {
  ...
  return {
    ...
    inputFields: (0, _lodash.merge)((0, _graphql2.parsePrimaryKeyinputFields)(model), attributeFields(model, {
      commentToDescription: true,
      globalId: false,
      exclude: (0, _graphql2.defaultExcludeFields)(model, exclude)
    })),
