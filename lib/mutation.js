...
function createCreateMutation(model, graphqlType) {
  ...
  return {
    ...
    inputFields: (0, _lodash.merge)((0, _utils.parsePrimaryKeyinputFields)(model, { exclude: ["id"].concat(exclude) }), (0, _graphqlSequelize.attributeFields)(model, {
      commentToDescription: true,
      globalId: false,
      exclude: (0, _utils.defaultExcludeFields)(model, exclude)
    })),
...
function createUpdateMutation(model, graphqlType) {
  ...
  return {
    ...
    inputFields: (0, _lodash.merge)((0, _utils.parsePrimaryKeyinputFields)(model, { exclude: exclude }), (0, _graphqlSequelize.attributeFields)(model, {
      commentToDescription: true,
      globalId: false,
      exclude: (0, _utils.defaultExcludeFields)(model, exclude)
    })),
